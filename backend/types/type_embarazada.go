...
type Embarazada struct {
	...
	AsistenciaPreg         bool      `json:"AsistenciaPreg"`
	ConsultaPregestacional time.Time `json:"ConsultaPregestacional,omitempty"`
	...
	VacunaCOVID           bool   `json:"vacunaCOVID"`
